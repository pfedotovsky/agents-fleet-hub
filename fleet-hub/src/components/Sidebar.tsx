...
import type { HostRuntime, Project } from '../types'
    ...
    case 'needs-setup':
      return (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          title="Open host to create the first account"
  ...
  return (
    ...
    >
      <button
        ...
        className={`flex min-w-0 flex-1 items-center gap-2 py-1.5 pl-5 text-sm ${
...
function HostSection({
  ...
  const activeId = view.kind === 'project' && view.hostId === hostId ? view.projectId : null
