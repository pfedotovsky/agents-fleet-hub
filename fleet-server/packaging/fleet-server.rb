...
class FleetServer < Formula
  ...
  homepage "https://github.com/pfedotovsky/agents-remote-control"
  version "0.1.0"
  license "AGPL-3.0-or-later"

  on_macos do
    on_arm do
      url "https://github.com/pfedotovsky/agents-remote-control/releases/download/server-v#{version}/fleet-server-#{version}-darwin-arm64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/pfedotovsky/agents-remote-control/releases/download/server-v#{version}/fleet-server-#{version}-linux-x64.tar.gz"
      sha256 "REPLACE_WITH_LINUX_X64_SHA256"
    end
    on_arm do
      url "https://github.com/pfedotovsky/agents-remote-control/releases/download/server-v#{version}/fleet-server-#{version}-linux-arm64.tar.gz"
